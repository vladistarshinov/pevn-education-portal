...
Vue.use(VueRouter)
  ...
  },
  {
    ...
    name: 'MyCourses',
    component: () => import(/* webpackChunkName: "Courses" */ '../views/student/MyCourses.vue')
  },
  {
    path: '/student/tasks/:c_id',
    name: 'StudTasks',
    component: () => import(/* webpackChunkName: "Courses" */ '../views/student/Tasks.vue')
  }
]
